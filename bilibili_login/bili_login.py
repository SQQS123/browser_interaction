...
class Crack():
    ...
    def bili_login(self):
        usrname = self.wait.until(EC.element_to_be_clickable((By.ID, 'login-username')))
        pwd = self.wait.until(EC.element_to_be_clickable((By.ID,'login-passwd')))
    ...
    def get_track(self, distance):
        ...
        while current < distance:
            ...
            # 我打算用匀速,前两次成功了,多次尝试会出现‘怪物吃掉了滑块’，表示失败
    ...
    def crack(self):
        ...
        # 根据位置对图片进行合并还原,并按照参数1的文件名内容保存文件
...
if __name__ == '__main__':
    crack = Crack('18871767932', '741963852')
    crack.crack()
    print('验证成功')
